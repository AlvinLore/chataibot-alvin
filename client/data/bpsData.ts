...
const STOPWORDS = new Set<string>([
  'kota','medan','jumlah','tahun','menurut','dan','di','yang','ke','atas','dari','pada',
  'dengan','per','persen','(persen)','(tahun)','(jiwa)','(km)','(miliar','rupiah)','(ribu','rupiah)',
  'triwulanan','harga','berlaku','konstan','atas','dasar','lahir','baru','lama','rata','rata-rata',
  'menjadi','sektor','kecamatan','kabupaten','kota','provinsi','sumatera','utara','data','dataset',
  'tabel'
]);
